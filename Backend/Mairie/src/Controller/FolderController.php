...
class FolderController extends AbstractController
{
   // Route pour récupérer toutes les dossiers
    #[Route('/api/folder', name: 'allFolder', methods: ['GET'])]
    ...
    #[Route('/api/folder/{id}', name: 'folderId', methods: ['GET'])]
    public function getDetailFolder(Folder $folder, FolderRepository $folderRepository, SerializerInterface $serializer): JsonResponse
    {   
   ...
   // Route pour modifier un dossier par son id
    ...
    public function updateFolder(Folder $folder, Request $request, EntityManagerInterface $update, SerializerInterface $serializer): JsonResponse
    {
    ...
    public function deleteFolder(Folder $folder, EntityManagerInterface $delete): JsonResponse
    {
        ...
        $delete->flush();
        return new JsonResponse('Folder supprimé avec succès', Response::HTTP_OK);
    }
