...
class CheckController extends AbstractController
{
    ...
    #[Route('/api/check', name: 'checkAll', methods: ['GET'])]
    ...
    #[Route('/api/check/{id}', name: 'checkId', methods: ['GET'])]
    ...
    public function deleteCheck(CheckFolder $checkFolder, EntityManagerInterface $delete): JsonResponse
    {
        ...
        $delete->flush();
        return new JsonResponse('Check supprimé avec succès', Response::HTTP_OK);
    }
}
