...
class ReservationController extends AbstractController
{
    ...
    #[Route('/api/reservation', name: 'allReservation', methods: ['GET'])]
    ...
    public function getDetailReservation(Reservation $reservation, ReservationRepository $reservationRepository, SerializerInterface $serializer): JsonResponse
    {   
